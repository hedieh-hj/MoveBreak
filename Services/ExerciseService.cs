...
public sealed class ExerciseService
{
    ...
    public IReadOnlyList<Exercise> All { get; } = new List<Exercise>
    {
        Exercise(1, ExerciseCategory.Neck, 40, "neck.png",
            "Gentle neck side stretch", "کشش جانبی گردن", "Estiramiento lateral suave del cuello",
            ...
            "Siéntate con la espalda recta. Acerca una oreja al hombro del mismo lado sin levantarlo. Mantén cada lado durante 20 segundos."),
        Exercise(2, ExerciseCategory.Shoulder, 45, "shoulder.png",
            "Shoulder rolls", "چرخش شانه‌ها", "Círculos de hombros",
            ...
            "Gira ambos hombros lentamente 10 veces hacia atrás y después 10 veces hacia delante."),
        Exercise(3, ExerciseCategory.Back, 40, "back.png",
            "Seated spinal twist", "چرخش نشسته کمر", "Rotación de columna sentado",
            ...
            "Siéntate con la espalda recta y gira suavemente el torso hacia un lado sin forzar. Mantén cada lado durante 20 segundos."),
        Exercise(4, ExerciseCategory.Wrist, 40, "wrist.png",
            "Wrist flexor stretch", "کشش مچ دست", "Estiramiento de flexores de muñeca",
            ...
            "Extiende un brazo y usa la otra mano para llevar suavemente los dedos hacia atrás. Repite con el otro lado."),
        Exercise(5, ExerciseCategory.Leg, 45, "leg.png",
            "Calf raises", "بالا بردن پاشنه", "Elevaciones de talones",
            ...
            "Ponte de pie junto al escritorio. Sube sobre las puntas 12 veces y baja lentamente, usando el escritorio solo para mantener el equilibrio."),
        Exercise(6, ExerciseCategory.Eye, 20, "eye.png",
            "20-20-20 eye break", "قانون ۲۰-۲۰-۲۰", "Descanso visual 20-20-20",
            ...
            "Mira durante 20 segundos un objeto situado al menos a 6 metros y parpadea con naturalidad."),
        Exercise(7, ExerciseCategory.Neck, 35, "chin-tuck.png",
            "Chin tuck", "جمع‌کردن چانه", "Retracción de la barbilla",
            ...
            "Mantén la mirada al frente y desplaza la cabeza recta hacia atrás, formando suavemente una papada. Mantén 5 segundos y repite 6 veces."),
        Exercise(8, ExerciseCategory.Neck, 40, "neck-rotation.png",
            "Gentle neck rotation", "چرخش آرام گردن", "Rotación suave del cuello",
            ...
            "Gira lentamente la cabeza para mirar por encima de un hombro. Mantén la barbilla nivelada y cada lado durante 15–20 segundos."),
        Exercise(9, ExerciseCategory.Shoulder, 35, "chest-opener.png",
            "Standing chest opener", "بازکردن قفسه سینه", "Apertura de pecho de pie",
            ...
            "Ponte de pie, entrelaza las manos detrás del cuerpo y lleva suavemente los hombros hacia atrás. Mantén durante 20 segundos."),
        Exercise(10, ExerciseCategory.Shoulder, 45, "wall-angel.png",
            "Wall angels", "حرکت فرشته روی دیوار", "Ángeles en la pared",
            ...
            "Apoya la espalda contra una pared y desliza lentamente los brazos flexionados hacia arriba y abajo. Mantén un rango cómodo y repite 8 veces."),
        Exercise(11, ExerciseCategory.Back, 35, "seated-forward-fold.png",
            "Seated forward fold", "خم‌شدن رو به جلو روی صندلی", "Flexión hacia delante sentado",
            ...
            "Apoya los pies en el suelo, inclínate hacia delante desde las caderas y relaja los brazos y la cabeza. Respira despacio durante 20–30 segundos."),
        Exercise(12, ExerciseCategory.Back, 30, "back-extension.png",
            "Standing back extension", "بازکردن کمر در حالت ایستاده", "Extensión de espalda de pie",
            ...
            "Coloca las manos en las caderas e inclínate solo un poco hacia atrás manteniendo el equilibrio. Vuelve lentamente y repite 5 veces."),
        Exercise(13, ExerciseCategory.Wrist, 30, "wrist-circles.png",
            "Wrist circles", "چرخش مچ‌ها", "Círculos de muñeca",
            ...
            "Relaja las manos y dibuja 8 círculos lentos con ambas muñecas en cada dirección."),
        Exercise(14, ExerciseCategory.Wrist, 30, "prayer-stretch.png",
            "Prayer wrist stretch", "کشش دعایی مچ", "Estiramiento de muñecas en oración",
            ...
            "Junta las palmas a la altura del pecho y baja ligeramente las manos hasta notar un estiramiento suave. Mantén durante 20 segundos."),
        Exercise(15, ExerciseCategory.Leg, 40, "knee-extension.png",
            "Seated knee extension", "بازکردن زانو روی صندلی", "Extensión de rodilla sentado",
            ...
            "Siéntate con la espalda recta y estira una rodilla hasta una posición cómoda. Mantén 3 segundos, baja y haz 8 repeticiones por lado."),
        Exercise(16, ExerciseCategory.Leg, 40, "quad-stretch.png",
            "Standing quadriceps stretch", "کشش جلوی ران", "Estiramiento de cuádriceps de pie",
            ...
            "Sujeta un escritorio estable para equilibrarte, acerca suavemente un talón al glúteo y toma el tobillo. Mantén cada lado durante 20 segundos."),
        Exercise(17, ExerciseCategory.Eye, 30, "eye-palming.png",
            "Eye palming", "استراحت چشم با کف دست", "Descanso ocular con las palmas",
            ...
            "Calienta las palmas, cierra los ojos y coloca las manos ahuecadas sobre ellos sin presionar. Respira lentamente durante 30 segundos."),
        Exercise(18, ExerciseCategory.Eye, 40, "focus-shift.png",
            "Near–far focus shift", "تغییر تمرکز نزدیک و دور", "Cambio de enfoque cerca-lejos",
            ...
            "Enfoca un dedo a la distancia del brazo durante 5 segundos y después un objeto lejano durante 5 segundos. Repite 4 veces sin forzar la vista.")
    };
    ...
    private static Exercise Exercise(int id, ExerciseCategory category, int duration, string image,
        string titleEn, string titleFa, string titleEs,
        string instructionsEn, string instructionsFa, string instructionsEs) => new()
    {
        Id = id,
        Category = category,
